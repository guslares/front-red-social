...
export const Sidebar = () => {
    ...
    const savePublication = async (e) => {
        ...
        // request para guardar datos en la bbdd
        ...
        <aside className="layout__aside">
            ...
            <div className="aside__container">
                ...
                <div className="aside__container-form">
                    ...
                    {stored == "error" ? <strong className='alert alert-danger'> "No se ha podido "</strong> : ""}


                    <form id="publaction-form" className="container-form__form-post" onSubmit={savePublication}>

                        <div className="form-post__inputs">
                            <label htmlFor="tex" className="form-post__label">¿Que estas pesando hoy?</label>
